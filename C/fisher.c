...
sample*
fisher_select_features(char *filename, sample *sample, int (*train)(struct sample*,double**,double*,int*,int), int number, int verbose)
{
    int i = 0;
    int j = 0;
    ...
    double *sd_neg  = NULL;
    double *sd_pos  = NULL;
    fisher_select_score *scores = NULL;
    ...
    /*alloc scores*/
    scores = (fisher_select_score*) malloc(dim*sizeof(fisher_select_score));
    ...
    qsort(scores, dim, sizeof(fisher_select_score), fisher_select_compare_score_greater);
 ...
 *----------------------------------------------------------*/
int
fisher_select_compare_score_greater(const void *a, const void *b)
{
    const fisher_select_score *ia = (const fisher_select_score*) a;
    const fisher_select_score *ib = (const fisher_select_score*) b;
